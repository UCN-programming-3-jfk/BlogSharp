...
namespace WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped((sc) => DAOFactory.CreateRepository<IAuthorDAO>(Configuration.GetConnectionString("DefaultConnection")));
            services.AddScoped((sc) => DAOFactory.CreateRepository<IBlogPostDAO>(Configuration.GetConnectionString("DefaultConnection")));
